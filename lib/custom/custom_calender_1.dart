                  ...
                  if (type == "0") {
                    ...
                    if (type == "W" || type == "CO" || type == "LH") {
                     foregroundColor = const Color(0xFF016DB5);
                      ...
                      foregroundColor = Colors.white;
                      border = roundBorder2(Colors.white, Color(0xFF00FE06));
                      textStyle = boldTextStyle(foregroundColor);

                    }
                    else if( type == 'WL'){
                      foregroundColor = Colors.white;
                      border = roundBorder2(Color(0xFF00FE06), Colors.white);
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else if( type == 'PW'){
                      foregroundColor = Colors.white;
                      border = roundBorder2(Color(0xFFFD0002),Color(0xFF00FE06));
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else if( type == 'WP'){
                      foregroundColor = Colors.white;
                      border = roundBorder2( Color(0xFF00FE06),Color(0xFFFD0002));
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else {
                      foregroundColor = const Color(0xFF016DB5);
                  ...
                  if (type == "0") {
                    ...
                    if (type == "W" || type == "CO" || type == "LH") {
                     ...
                     border = rectangleBorder(backgroundColor);
                      ...
                      foregroundColor = Colors.white;
                      border = rectangleBorder2(Colors.white, Color(0xFF00FE06));
                      textStyle = boldTextStyle(foregroundColor);

                    }
                    else if( type == 'WL'){
                      foregroundColor = Colors.white;
                      border = rectangleBorder2(Color(0xFF00FE06), Colors.white);
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else if( type == 'PW'){
                      foregroundColor = Colors.white;
                      border = rectangleBorder2(Color(0xFFFD0002),Color(0xFF00FE06));
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else if( type == 'WP'){
                      foregroundColor = Colors.white;
                      border = rectangleBorder2(Color(0xFF00FE06), Color(0xFFFD0002));
                      textStyle = boldTextStyle(foregroundColor);
                    }
                    else {
                      foregroundColor = const Color(0xFF016DB5);
